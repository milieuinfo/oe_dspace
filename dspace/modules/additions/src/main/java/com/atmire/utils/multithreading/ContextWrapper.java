...
public class ContextWrapper extends Context {
     ...
     * is authenticated.
     *
     * @throws java.sql.SQLException if there was an error obtaining a database connection
     */
     ...
     * the context.
     *
     * @throws java.sql.SQLException if there was an error completing the database transaction
