            ...
            <div class="wrapper clearfix"> <xsl:comment></xsl:comment>
                <div class="main-navigation-inner clearfix inner">
                    ...
                    <ul id="service-navigation" class="clearfix">
                        <li><a href="http://www.onroerenderfgoed.be">Home Onroerend Erfgoed</a></li>
                    </ul>
                    <!-- logo -->
                    <div class="logo-block">
                      <a href="/">
                        <div class="logo-block-title"><h1>OAR</h1></div>
                        <img src="{$theme-path}/lib/img/pyoes/OE-vlaanderen-logo.png" width="65"></img>
                        <h2>Vlaanderen</h2>
