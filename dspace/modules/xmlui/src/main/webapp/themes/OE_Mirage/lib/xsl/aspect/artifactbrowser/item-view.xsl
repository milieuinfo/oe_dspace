...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 4 and (dim:field[@element='relation' and @mdschema='dc' and descendant::text()])">
                    <div class="simple-item-view-other">
                    <xsl:for-each select="dim:field[@element='relation']">
                            ...
                            <span>
                                 <a>
                                      <xsl:attribute name="href">
                                          <xsl:value-of
                                              select="concat($context-path,'/browse?type=series&amp;value=')"/>
                                          <xsl:copy-of select="."/>
                                      </xsl:attribute>
                                      <xsl:value-of select="text()"/>
                                  </a>
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='type' and @mdschema='dc' and not(@qualifier)])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 7 and (dim:field[@element='source' and @mdschema='dc' and not(@qualifier)])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 8 and (dim:field[@element='identifier' and @mdschema='dc' and not(@qualifier)])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 9 and (dim:field[@element='publisher' and @mdschema='dc' and not(@qualifier)])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 10 and (dim:field[@element='title' and @mdschema='dc' and @qualifier='alternative'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 11 and (dim:field[@element='document' and @mdschema='imjv' and @qualifier='title'])">
              <div class="simple-item-view-other">
          ...
          <!-- Abstract row -->
          <xsl:when test="$clause = 12 and (dim:field[@element='description' and @qualifier='abstract' and descendant::text()])">
          ...
          <!-- Description row -->
          <xsl:when test="$clause = 13 and (dim:field[@element='description' and not(@qualifier) and descendant::text()])">
                <div class="simple-item-view-description">
